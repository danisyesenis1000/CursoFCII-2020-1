...
void Nomina( char [][10], char [][20], float*, float*, float*); //Función prototipo.
...
int main()
{
  ...
  float Pago[] = {0,0,0,0};    // Arreglo donde va a ir la nomina
  ...
  Nomina( Nombres, Tarifas, Horas, Trabajadas, Pago);    
...
void Nomina(char Nombres[][10], char Tarifas[][20], float * Horas, float * Trabajadas, float * Pago)  
{
